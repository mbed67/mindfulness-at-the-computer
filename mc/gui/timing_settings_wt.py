...
class TimingSettingsWt(QtWidgets.QWidget):
    ...
    def _init_ui(self):
        ...
        # Settings
        grid.addWidget(H2(self.tr("Breathing Notifications")), 0, 0, 1, 8)
        grid.addWidget(HorizontalLine(), 1, 0, 1, 8)
        grid.addWidget(QtWidgets.QLabel(self.tr("Interval every:")), 2, 0, 1, 2)
        grid.addWidget(self.notification_interval_qsb, 2, 2, 1, 2)
        grid.addWidget(QtWidgets.QLabel(self.tr("minutes")), 2, 4, 1, 2)
        grid.addWidget(QtWidgets.QLabel(), 3, 0)
        grid.addWidget(H2(self.tr("Breathing Dialog")), 4, 0, 1, 8)
        grid.addWidget(HorizontalLine(), 5, 0, 1, 8)
        grid.addWidget(QtWidgets.QLabel(self.tr("Show after:")), 6, 0, 1, 2)
        grid.addWidget(self.show_after_qsb, 6, 2, 1, 2)
        grid.addWidget(QtWidgets.QLabel(self.tr("notifications")), 6, 4, 1, 2)
        grid.addWidget(QtWidgets.QLabel(), 7, 0)
        grid.addWidget(H2(self.tr("Rest Dialog")), 8, 0, 1, 8)
        grid.addWidget(HorizontalLine(), 9, 0, 1, 8)
        grid.addWidget(QtWidgets.QLabel(self.tr("Interval every:")), 10, 0, 1, 2)
        grid.addWidget(self.rest_interval_qsb, 10, 2, 1, 2)
        grid.addWidget(QtWidgets.QLabel(self.tr("minutes")), 10, 4, 1, 2)
        grid.addWidget(QtWidgets.QLabel(self.tr("Time until next break:")), 11, 0, 1, 2)
        grid.addWidget(self.rest_reminder_qsr, 11, 2, 1, 5)
        grid.addWidget(self.rest_reminder_reset_qpb, 11, 7)
        grid.setColumnStretch(4, 1)
        grid.setColumnStretch(9, 4)

        # Overview
        grid.addWidget(QtWidgets.QLabel("This is an overview of your notifications"), 0, 9)
        grid.addWidget(self.overview_qlw, 1, 9, 11, 1)
